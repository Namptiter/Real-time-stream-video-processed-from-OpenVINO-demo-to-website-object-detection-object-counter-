    ...
    while cap.isOpened():
        ...
        for obj in objects:
            ...
            cv2.putText(frame,
                        ...
                        (obj['xmin'], obj['ymin'] - 7), cv2.FONT_HERSHEY_COMPLEX, 0.6, (255,255,0), 1)
        ...
        count_obj = "Total object: {}".format(count)
        ...
        cv2.putText(frame,count_obj, (15, 65), cv2.FONT_HERSHEY_COMPLEX, 0.6, (10, 0, 255), 1)
        start_time = time()
        ...
        sio.emit('img',base64.b64encode(data))
